...
$Actor = [ResolveActor](https://msdn.microsoft.com/ee663894.aspx#ResolveActor)(./Subscriber)
<span style="FONT-WEIGHT: bold">Map values:</span>
 
|                                                                                                                                                                     |                   |                                     |
|---------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------|-------------------------------------|
...
|                                                                                                                                  |                       |                                          |
|----------------------------------------------------------------------------------------------------------------------------------|-----------------------|------------------------------------------|
| [GetDateTime](https://msdn.microsoft.com/ee663894.aspx#GetDateTime)(., "<span style="FONT-STYLE: italic">encounter-date"</span>) | ./when                | DateTimeType =&gt; date-time             |
...
| [ResolveActor](https://msdn.microsoft.com/ee663894.aspx#ResolveActor)(./Locations/Location\[1\]/Actor/ActorID)                   | ./facility            | Actor =&gt; Organization                 |

<span style="FONT-WEIGHT: bold">ForEach</span>(./Practitioners/Practitioner)
$Practitioners = [Concat](https://msdn.microsoft.com/ee663894.aspx#Concat)($Practitioners, ., <span style="FONT-STYLE: italic">"\\n\\n"</span>)
<span style="FONT-WEIGHT: bold">Map values:</span>
 
|     |           |                                     |
|-----|-----------|-------------------------------------|
...
$DateTime = [GetDateTime](https://msdn.microsoft.com/ee663894.aspx#GetDateTime)(.,<span style="FONT-STYLE: italic">"appointment-date"</span>)
<span style="FONT-WEIGHT: bold">If Exists</span>($DateTime/ExactDateTime)
<span style="FONT-WEIGHT: bold">Map values:</span>
 
|                                                   |                                                                   |                                          |
...
$Practitioner = [ResolveActor](https://msdn.microsoft.com/ee663894.aspx#ResolveActor)(./Practitioners/Practitioner\[1\]/ActorID)
...
$Location = [ResolveActor](https://msdn.microsoft.com/ee663894.aspx#ResolveActor)(./Locations/Location\[1\]/Actor/ActorID)
