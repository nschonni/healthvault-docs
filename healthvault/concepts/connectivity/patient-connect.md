...
<p>For example: https:// <em>shellhostname</em>/redirect.aspx?target=CONNECT&amp;targetqs=packageid%3d <em>JKYZ-QNMN-VHRX-ZGNR-GZNH</em>. For more more information, see <a href="shell-redirect-interface" id="PageContent_14091_2">Shell Redirect Interface</a>.</p></td>
</tr>
<tr class="even">
