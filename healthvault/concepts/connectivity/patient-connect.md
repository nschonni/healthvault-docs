...
<p>For example: https:// <em>shellhostname</em>/redirect.aspx?target=CONNECT&amp;targetqs=packageid%3d <em>JKYZ-QNMN-VHRX-ZGNR-GZNH</em>. For more more information, see <a href="/healthvault/concepts/connectivity/shell-redirect-interface" id="PageContent_14091_2">Shell Redirect Interface</a>.</p></td>
</tr>
<tr class="even">
...
The HealthVault .NET SDK contains classes and methods in the [Microsoft.Health.PatientConnect](https://docs.microsoft.com/en-us/dotnet/api/microsoft.health.patientconnect) namespace for creating and managing Patient Connect connect requests.
