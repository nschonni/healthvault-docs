...
---|---|---|---|---|---
raised-insight-id|string128nw|1|1|Unique id of this insight instance.|
catalog-id|string128nw|1|1|Id of the catalog item for this insight.|
when|date-time|1|1|The date and time the insight was created.|
expiration-date|date-time|1|1|Date when the insight expires.|
channel|string128nw|0|1|Shows what does this Insight impact. For example sleep or activity etc.|
algo-class|string128nw|0|1|Represents the algorithm class used to create this Insight.|
directionality|string128nw|0|1|Represents which way the Insight is trending. For example positive, negative or neutral.|
time-span-pivot|string128nw|0|1|Represents the aggregation time span of the data. For example, data is aggregated weekly or daily.|
comparison-pivot|string128nw|0|1|Represents how the user was compared for deriving this Insight. Example with themselves or people similar to the user.|
tone-pivot|string128nw|0|1|Represents the tone of the Insight, like better or worse.|
scope-pivot|string128nw|0|1|Represents the scope of the Insight. For example, for a specific event or event types.|
...
origin|string128nw|0|1|Where was this insight generated.|
