...
> Name|Type|Min occurs|Max occurs|Summary|Remarks
> ---|---|---|---|---|---
> target-date|approx-date-time|0|1|The date upon which the person wants to complete the goal.|
> completion-date|approx-date-time|0|1|The date on which the goal was completed.|
...
> ---|---|---|---|---|---|---
> base-time|date-time|1|1|Sample set base time from which samples are offset.||
