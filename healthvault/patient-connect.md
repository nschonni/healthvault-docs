...
The HealthVault .NET SDK contains classes and methods in the [Microsoft.Health.PatientConnect](microsoft.health.patientconnect-namespace.md) namespace for creating and managing Patient Connect connect requests.
